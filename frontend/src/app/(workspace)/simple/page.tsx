      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className="w-72 bg-white border-l border-gray-100 flex flex-col overflow-hidden shrink-0">
          <div className="px-4 pt-3 pb-2 border-b border-gray-100 shrink-0">
            <h2 className="text-xs font-semibold text-gray-400 uppercase tracking-wider">导出</h2>
          </div>
          <div className="flex-1 overflow-y-auto">
            <ExportPanel />
          </div>
          <div className="px-4 py-3 border-t border-gray-100 shrink-0">
            <Link
              href="/audio"
              className="flex items-center gap-2 w-full px-3 py-2.5 rounded-xl bg-orange-50 hover:bg-orange-100 border border-orange-200 hover:border-orange-300 transition-all group"
            >
              <span className="text-base">🎵</span>
              <div className="flex-1 min-w-0">
                <p className="text-xs font-medium text-orange-600">音频生成控制台</p>
                <p className="text-[10px] text-orange-400">AI 配乐 · 音色克隆</p>
              </div>
              <svg className="w-3 h-3 text-orange-400 group-hover:translate-x-0.5 transition-transform shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
